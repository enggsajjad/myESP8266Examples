...
const char *ssid =  "UPC0870375";   // name of your WiFi network
const char *password =  "Ghnfdd6byuxp"; // password of the WiFi network
...
//192.168.35.1
//192.168.0.164
IPAddress broker(192,168,0,164); // IP address of your MQTT broker eg. 192.168.1.50
WiFiClient wclient;
