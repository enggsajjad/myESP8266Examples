    ...
    switch(gState)
    {
      ...
      case 1:
        ...
        else
        {
          switch(curDirection)
          {
            case 1: if(average[0]>1.5) {Serial.println("left");curDirection = 0; gState = 0; cntms = 0;} break;
            case 2: if(average[0]<-2)  {Serial.println("right");curDirection = 0; gState = 0; cntms = 0;} break;
            case 3: if(average[2]>2)  {Serial.println("away");curDirection = 0; gState = 0; cntms = 0;} break;
            case 4: if(average[2]<-2.5) {Serial.println("close");curDirection = 0; gState = 0; cntms = 0;} break;
          }
        }
        break;
    }
